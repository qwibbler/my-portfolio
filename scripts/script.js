...
const projectsInfo = [
  ...
  },
  {
    ...
    imgCard: "url('https://github.com/qwibbler/leaderboard/blob/dev/img/Screenshot-portfolio-card.png')",
    imgDesk: 'https://github.com/qwibbler/leaderboard/blob/dev/img/Screenshot-portfolio-big.png',
    imgPopup: 'https://github.com/qwibbler/leaderboard/blob/dev/img/Screenshot-portfolio-mobile.png',
